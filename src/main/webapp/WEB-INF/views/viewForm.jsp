...
<body>
	...
	<div id="mydiv"
		style="position: absolute; left: 70px; top: 58px; padding-top: 12px; padding-bottom: 10px;">
		<table>
			<tr>
				<td align="left"><font color="black"
					style="font-family: sans-serif; font-size: 15px;">&nbsp;&nbsp;
						EMPLOYEE DETAILS</font></td>
				<td></td>
				<td align="right">
	...
	<div style="position: absolute; left: 70px; top: 104px;" id="mydiv">
		<table class="table table-hover">
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Personal
						Details :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Bank
						Details :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left">
				...
				<td><label>UAN No :</label> ${user.getUanNumber()}</td>
			</tr>
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Family
						Details :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Education
						Details :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Computer
						Knowledge :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">
						Languages Known :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Previous
						Employment Details :</font></td>
			</tr>
			<tr align="left">
			...
			<tr align="left" style="background-color: #E8E8E8">
				<td colspan="3"><font color="#42B5F4" size="3px">Passport
						/ Visa Details :</font></td>
			</tr>
			<tr align="left">
